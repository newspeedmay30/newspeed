				...
				<div class="option clearfix">
					...
					<div id="post_strip_external" class="field f_100">
						...
						<div class="option clearfix">
 						...
 						<div class="option clearfix">
							<input name="camp_options[]"   value="OPT_STRIP_INLINE" type="checkbox"> <span class="option-title"> Strip inline links (links that show as a text and not clickable) </span>
 						</div>
