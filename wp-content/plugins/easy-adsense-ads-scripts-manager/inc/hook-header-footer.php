...
add_action( 'amp_post_template_head', 'eaa_header_scripts_amp' );

function eaa_header_scripts_amp() {
	global $eaa;
	echo stripslashes( $eaa->get_option( 'header_scripts_amp' ) );
}

add_action( 'amp_post_template_footer', 'eaa_footer_scripts_amp' );

function eaa_footer_scripts_amp() {
	global $eaa;
	echo stripslashes( $eaa->get_option( 'footer_scripts_amp' ) );
}
