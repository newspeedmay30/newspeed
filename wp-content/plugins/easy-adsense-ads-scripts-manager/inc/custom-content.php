...
', 'eaa' ),
	...
	$wp_customize->add_setting( 'eaa[header_scripts_amp]', array(
		'default' => '',
		'type'    => 'option',
	) );
	$wp_customize->add_setting( 'eaa[footer_scripts_amp]', array(
		'default' => '',
		'type'    => 'option',
	) );


	$wp_customize->add_control( 'eaa[header_scripts_amp]', array(
		'label'       => __( 'Header scripts for AMP pages', 'eaa' ),
		'description' => __( 'Add your analytics code, meta tags for website ownership verification and any thing else that should go in the head tag of your website.', 'eaa' ),
		'section'     => 'custom_scripts',
		'type'        => 'textarea',
		'active_callback' => function(){
			$settings = get_option( 'eaa_settings' );
			return isset($settings['enable_amp_support']);
		}
	) );

	$wp_customize->add_control( 'eaa[footer_scripts_amp]', array(
		'label'       => __( 'Footer scripts for AMP pages', 'eaa' ),
		'description' => __( 'Any scripts and tags that should be added to your website footer.', 'eaa' ),
		'section'     => 'custom_scripts',
		'type'        => 'textarea',
		'active_callback' => function(){
